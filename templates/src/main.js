...
Vue.component('icon', Icon)
        ...
        var myList=Vue.component('repo-item', {
          props: ['title', 'url', 'desc', 'domain', 'api_type', 'api_url', 'api_doc_url', 'owner', 'admin'],
          template: ` <tr>
            ...
            <td v-if="!admin"><button :disabled="owner==0" v-on:click="$emit(\'edit\')"><icon name="edit" style="color: #000000"></icon></button></td> \
            <td v-if="!admin"><button :disabled="owner==0" v-on:click="$emit(\'remove\')"><icon name="ban" style="color: #FF0000"></icon></button></td> \
            <td v-if="admin"><button v-on:click="$emit(\'edit\')"><icon name="edit" style="color: #000000"></icon></button></td> \
            <td v-if="admin"><button v-on:click="$emit(\'remove\')"><icon name="ban" style="color: #FF0000"></icon></button></td> </tr>`
